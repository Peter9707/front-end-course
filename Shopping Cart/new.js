...
// Add the ui object with the displayProducts function if not already defined
const ui = {
  displayProducts(products) {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  products
    ...
    .then(() => {
      ui.getBagButtons();
      ui.cartLogic();
      // Add functionality to the "Shop Now" button
      const shopNowButton = document.getElementById("shop-now-btn");
      shopNowButton.addEventListener("click", () => {
        const targetSectionId = "our-products";
  ...
  filterButtons.forEach((button) => {
    button.addEventListener("click", () => {
      ...
      products.filterProducts(category).then((filteredProducts) => {
